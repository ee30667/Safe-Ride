        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "text", nullable: false, defaultValue: "Passenger"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating1Count = table.Column<int>(type: "integer", nullable: false),
                    Rating2Count = table.Column<int>(type: "integer", nullable: false),
                    Rating3Count = table.Column<int>(type: "integer", nullable: false),
                    Rating4Count = table.Column<int>(type: "integer", nullable: false),
                    Rating5Count = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalFare = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    DistanceKm = table.Column<double>(type: "double precision", nullable: true),
                    SurgeMultiplier = table.Column<decimal>(type: "numeric(4,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rides_DriverProfiles_DriverProfileId",
                        column: x => x.DriverProfileId,
                        principalTable: "DriverProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RideRatings_Rides_RideId",
                        column: x => x.RideId,
                        principalTable: "Rides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RideRatings_Users_RaterId",
                        column: x => x.RaterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "IsActive", "IsVerified", "PasswordHash", "PhoneNumber", "Role" },
                values: new object[] { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@saferide.com", "Admin", true, true, "$2a$11$3p3Dll2YnB.zDs0ngnQKJ.vReqkylR3BIY6dFDNWJiIAGxGqTkDk6", "0000000000", "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RideRatings_RaterId",
                table: "RideRatings",
                column: "RaterId");

            migrationBuilder.CreateIndex(
                name: "IX_RideRatings_RideId",
                table: "RideRatings",
                column: "RideId",
                unique: true);
